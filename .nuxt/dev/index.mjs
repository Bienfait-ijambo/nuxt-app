...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/devalue/index.js';
import destr from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/vue/index.mjs';
import { hash } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/nuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Laravel%2011/htdocs/projects/nuxt-app/node_modules/@unhead/shared/dist/index.mjs';
...
const rootDir = "C:/Laravel 11/htdocs/projects/nuxt-app";
...
const _lazy_2Q2kj7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_2Q2kj7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2Q2kj7, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"C:/Laravel 11/htdocs/projects/nuxt-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Laravel 11\\htdocs\\projects\\nuxt-app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Laravel 11\\htdocs\\projects\\nuxt-app\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Laravel 11\\htdocs\\projects\\nuxt-app\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Laravel 11\\htdocs\\projects\\nuxt-app\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Laravel 11\\htdocs\\projects\\nuxt-app\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file://C:/Laravel%2011/htdocs/projects/nuxt-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Laravel%2011/htdocs/projects/nuxt-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
