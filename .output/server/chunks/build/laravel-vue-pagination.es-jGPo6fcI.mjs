...
}, A = ["tabindex"], D = /* @__PURE__ */ createElementVNode("span", { "aria-hidden": "true" }, "\xAB", -1), z = /* @__PURE__ */ createElementVNode("span", { class: "sr-only" }, "Previous", -1), O = {
  key: 0,
  class: "sr-only"
}, N = ["tabindex"], j = /* @__PURE__ */ createElementVNode("span", { "aria-hidden": "true" }, "\xBB", -1), L = /* @__PURE__ */ createElementVNode("span", { class: "sr-only" }, "Next", -1);
...
}, V = ["tabindex"], T = /* @__PURE__ */ createElementVNode("span", { "aria-hidden": "true" }, "\xAB", -1), F = ["aria-current"], H = ["tabindex"], q = /* @__PURE__ */ createElementVNode("span", { "aria-hidden": "true" }, "\xBB", -1);
...
}, J = ["disabled"], K = /* @__PURE__ */ createElementVNode("span", { class: "sr-only" }, "Previous", -1), Q = /* @__PURE__ */ createElementVNode("svg", {
  class: "w-5 h-5",
  "aria-hidden": "true",
...
], -1), W = ["aria-current", "disabled"], X = ["disabled"], Y = /* @__PURE__ */ createElementVNode("span", { class: "sr-only" }, "Next", -1), Z = /* @__PURE__ */ createElementVNode("svg", {
  class: "w-5 h-5",
  "aria-hidden": "true",
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
...
export { ae as Bootstrap4Pagination, ne as Bootstrap5Pagination, B as RenderlessPagination, ie as TailwindPagination };
//# sourceMappingURL=laravel-vue-pagination.es-jGPo6fcI.mjs.map
