import { ref, useSSRContext, withAsyncContext, unref, mergeProps, withCtx, createVNode, toDisplayString } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderStyle, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderAttr, ssrRenderList } from 'vue/server-renderer';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-82adfabd><h1 class="text-2xl mb-2" data-v-82adfabd>Post-list </h1>`);
      ...
      if ((_a = unref(data)) == null ? void 0 : _a.data) {
        ...
        _push(`<span class="shadow-md px-2 py-2 rounded-md mt-20 text-gray-900 border font-semibold text-center" data-v-82adfabd>No data found <br data-v-82adfabd> Check your internet connection </span>`);
      }
      if (unref(data).data) {
...
const listOfPosts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-82adfabd"]]);

export { listOfPosts as default };
//# sourceMappingURL=list-of-posts-C1wynuN1.mjs.map
